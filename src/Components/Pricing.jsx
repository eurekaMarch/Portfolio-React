    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          ...
          <h3 className="pricing__price"><sup>$</sup> 9 <span>Month</span></h3>
          <a href="" className="btn">Get Started</a>
        </div>
        
        <div className="pricing__item pricing__best" >
          ...
          <h3 className="pricing__price"><sup>$</sup> 49 <span>Month</span></h3>
          <a href="" className="btn">Get Started</a>
        </div>
        ...
        <div className="pricing__item">
          ...
          <h3 className="pricing__price"><sup>$</sup> 99 <span>Month</span></h3>
          <a href="" className="btn">Get Started</a>
        </div>
      </div>
    </section>
